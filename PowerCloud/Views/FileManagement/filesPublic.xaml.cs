...
public partial class filesPublic : ContentPage
{
    ...
    private async void ToolbarItem_Upload_Clicked(object sender, EventArgs e)
    {
        //MainNasFileViewModel mvm = (MainNasFileViewModel)myControl.BindingContext;
        //if (mvm == null)
        //    return;
    ...
    {
        //await Navigation.PushPopupAsync(new FileManagement_Popup_SelectMore((MainNasFileViewModel)myControl.BindingContext));
    }
}