...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// <summary>
        /// from a Java.IO.File file to Android.Net.Uri
        /// </summary>
        /// <param name="file"></param>
        /// <returns></returns>
        internal static AndroidUri GetUriForFile(Java.IO.File file) =>
                //Xamarin.Essentials.FileProvider.GetUriForFile(Platform.AppContext, Authority, file);
                AndroidX.Core.Content.FileProvider.GetUriForFile(Platform.AppContext, Authority, file);
