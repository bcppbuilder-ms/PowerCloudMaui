...
namespace PowerCloud.Ite2
{
    ...
    public static class Platform
    {
        ...
        /// <summary>
        /// function without async but calls a async funrion --> don't use await but uses Invoke.
        /// </summary>
        ...
        public static Bundle MainBundle { get; set; }
        ...
        internal static AndroidUri GetShareableFileUri(FileBase file)
        {
            ...
            if (HasApiLevelN)
            {
                return /*Xamarin.Essentials.*/FileProvider.GetUriForFile(Platform.AppContext, Platform.AppContext.PackageName + ".fileProvider", sharedFile);
            }
